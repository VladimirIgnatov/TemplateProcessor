...
use TemplateProcessor\TemplateProcessor;
 ...
 *
 * @method  bool addFile(StringElement $filename, StringElement $localname = null)
 * @method  bool addFromString(StringElement $localname, StringElement $contents)
 * @method  StringElement getNameIndex(int $index)
 * @method  int locateName(StringElement $name)
 *
 * @since   0.10.0
 */
class ZipArchive
{
    ...
    {
        $this->usePclzip = ($this::getZipClass() != 'ZipArchive');
        if ($this->usePclzip) {
            if (!defined('PCLZIP_TEMPORARY_DIR')) {
                define('PCLZIP_TEMPORARY_DIR', TemplateProcessor::getTempDir() . '/');
            }
